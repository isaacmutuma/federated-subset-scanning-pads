...
for fold_idx, fold in enumerate(folds):
    ...
    print("Transforming...")
    X_train = rocket.transform(train_win)
    X_test  = rocket.transform(test_win)
    ...
    window_scores = clf.decision_function(X_test)

    # ── Subject-level aggregation — mean pool decision scores ─────────────────
